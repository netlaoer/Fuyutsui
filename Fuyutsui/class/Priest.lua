...
function fu.updateSpecInfo()
    ...
    if specIndex == 1 then
        ...
        fu.blocks = {
            ...
            spell_cd = {
                [17] = { index = 24, spellId = 17, name = "真言术：盾" },
                [47540] = { index = 25, spellId = 47540, name = "苦修" },
                [194509] = { index = 27, spellId = 194509, name = "真言术：耀" },
                [527] = { index = 28, spellId = 527, name = "纯净术" },
                [19236] = { index = 29, spellId = 19236, name = "绝望祷言" },
                [8092] = { index = 30, spellId = 8092, name = "心灵震爆" },
                [472433] = { index = 31, spellId = 472433, name = "福音" },
                [32379] = { index = 32, spellId = 32379, name = "暗言术：灭" },
                [232633] = { index = 33, spellId = 232633, name = "奥术洪流" },
                [8122] = { index = 34, spellId = 8122, name = "心灵尖啸", failed = true },
                [32375] = { index = 35, spellId = 32375, name = "群体驱散", failed = true },
                [62618] = { index = 36, spellId = 62618, name = "真言术：障", failed = true },
                [421453] = { index = 37, spellId = 421453, name = "终极苦修", failed = true },
            },
            spell_charge = {
                [47540] = { index = 26, spellId = 47540, name = "苦修" }
            },
        }
        fu.group_blocks = {
            unit_start = 40,
